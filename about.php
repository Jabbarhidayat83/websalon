...
<body>
    <div>
        ...
        <div class="ratakiri">
            <p>Deskripsi About Us panjang lebar luas dalam...</p>
            <p class="bigtext">Contact Us</p>
            <p>Customer Services Hotline : (+62)8xx xxxx xxxx</p>
            <p>Customer Services Email : support@namaperusahaan.id</p>
        </div>
